---
description: 코드 변경 → README / ADR / CHANGELOG / HANDOFF / skill-catalog 5 영역 동기화. 변경 종류 별 매트릭스 + automation hook (pre-commit / CI / commitlint / markdownlint).
argument-hint: "<commit 또는 batch 식별>"
