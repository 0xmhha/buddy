...
M1~M4 완료 — v0.1 user-facing CLI 한 번 통과.
- M1 schema/SQLite/outbox · M2 hook-wrap · M3 daemon+aggregator+cli-wrapper · M4 install/uninstall/doctor/stats/events
- 11개 패키지, 100+ tests pass (race-clean), ~9.5MB static binary
