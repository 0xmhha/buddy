...
// scheduled agent would fire next), and in-app delete with confirmation
// (d → y/N prompt → FK-cascading delete). Create form and live log tail
// remain follow-on per cli-buddy-spec §9 W3-2.
//
...
func newTuiCmd() *cobra.Command {
	...
	c := &cobra.Command{
		Use:   "tui",
		Short: "Open the cli buddy terminal UI (agent list, detail, scheduler, in-app delete)",
