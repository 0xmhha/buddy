...
| W3-2 TUI | bubbletea 학습 + agent list / create form | HIGH (partial Done 2026-05-13 — minimum-viable: bubbletea + lipgloss deps + `buddy tui` subcommand + read-only agent list view with j/k navigation, g/G jump, r refresh, q quit, AltScreen lifecycle. Detail / create / log views remain follow-on) | W3-1 |
